...
export function MusicLab() {
  ...
  const startThemeNow = useCallback(
    ...
    [combo, ensure, intensity, mode, profile, seed],
  );
    ...
    <div className="min-h-dvh bg-bg text-fg">
      <div className="mx-auto flex max-w-6xl flex-col gap-5 px-4 py-6 pb-16 sm:px-6 lg:px-8">
        <header className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <p className="text-xs font-medium tracking-[0.22em] text-muted uppercase">Órbita · v1.1 cinematic mix</p>
            <h1 className="mt-1 font-display text-4xl font-medium tracking-tight text-fg sm:text-5xl">
              Music Lab
            </h1>
            <p className="mt-2 max-w-xl text-sm leading-relaxed text-muted">
              Original procedural soundtrack. Offline, seeded, and mixed for actual listening — not a thin sketch.
            </p>
          </div>
