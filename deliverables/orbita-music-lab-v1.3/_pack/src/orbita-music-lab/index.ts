...
export { realizeMotif, varyMotif, varyMotifComposed, variationForStage } from "./theory/motifs.ts";
...
export { phrasePlanFor, summarizePhrase } from "./composition/phrase.ts";
export { grammarFor, GRAMMARS } from "./composition/grammar.ts";
export {
  classifyNote,
  polishPhrase,
  tensionPolicyFor,
...
export { BIOMES, MOODS, THEME_IDS, GAME_MODES, LAB_LAYERS } from "./core/types.ts";
