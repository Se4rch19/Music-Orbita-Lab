...
**v1.3** is a composer pass: 8-bar phrases, curated campaign progressions, motif development with repetition, coordinated layers, cadences, and a lab-only composer debug panel. Mix and planet identities from v1.2 stay. A/B/C the lab between **v1.1**, **v1.2**, and **v1.3**.
...
5. Toggle **v1.3 / v1.2 / v1.1** on the same seed. v1.3 should sound more written, not merely safer.
6. Open **Composer debug**: solo melody vs counter, loop A or PEAK, restart/next phrase.
7. Toggle **Phone speaker preview** for a crude small-speaker EQ. It is a lab tool, not a device emulator.
...
Transport (lookahead scheduler)
  → Phrase planner (8-bar thought: cadence, motif stage, orchestration)
